...
carnival.addLabelTo("BlackByte", carnival.Areas.Bottom)
carnival.startCountdownGame(15, carnival.WinTypes.Multi)
game.showLongText("Player 1: Use the arrow keys to move the hammer. Player 2: Press A to move the mole.", DialogLayout.Full)
game.showLongText("NNC is Here tooo", DialogLayout.Full)
